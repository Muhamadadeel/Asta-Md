...
smd({
  ...
  try {
    ...
    for (let _0x5ed6e8 = 0; _0x5ed6e8 < _0x3da7c6.length; _0x5ed6e8++) {
      try {
        await _0x90a6de.bot.groupRequestParticipantsUpdate(_0x90a6de.from, [_0x3da7c6[_0x5ed6e8].jid], "accept");
...
smd({
  ...
  try {
    ...
    if (_0xadbad4.metadata?.announce) {
      return await _0xadbad4.reply("*Uhh " + (_0xadbad4.isSuhail ? "Buddy" : "Idiot") + ", Group already muted*");
    }
...
smd({
  ...
  try {
    ...
    if (!_0x5d1afd.metadata?.announce) {
      return await _0x5d1afd.reply("*Hey " + (_0x5d1afd.isSuhail ? "Buddy" : "Idiot") + ", Group already unmute*");
    }
...
smd({
  ...
  try {
    ...
    if (_0x1dca9f.metadata.restrict) {
      return await _0x1dca9f.reply("*Hey " + (_0x1dca9f.isSuhail ? "Buddy" : "Idiot") + ", Group setting already locked*");
    }
...
smd({
  ...
  try {
    ...
    if (!_0xe880ee.metadata.restrict) {
      return await _0xe880ee.reply("*Hey " + (_0xe880ee.isSuhail ? "Buddy" : "Idiot") + ", Group setting already unlocked*");
    }
...
cmd({
  ...
  try {
    ...
    if (!_0x3d5ec9.isBotAdmin) {
      return await _0x3d5ec9.reply("*_I'm Not Admin In This Group, " + (_0x3d5ec9.isSuhail ? "Buddy" : "Idiot") + "_*");
    }
