let { smd, smdBuffer, tlang, sleep } = require("../lib");
let fs = require("fs");
var sifat = [
  "Fine",
  "Unfriendly",
  ...
  async (_0x173fc2, _0x1e33bd) => {
    try {
      ...
      for (let _0x12e4c4 of _0x1fd73d.participants) {
        let _0x2f7779 = /923184474176|923004591719/g.test(_0x12e4c4.id)
          ? "Suhail Ser"
