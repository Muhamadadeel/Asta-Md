let {
 ...
 smd({
   ...
   try {
     ...
     let _0x162ed5 = "*_https://whatsapp.com/channel/0029VaPGt3QEwEjpBXT4Rv0z_*\n*_JOIN WHATSAPP CHANNEL TO GET UPDATES._*\n";
     let _0x39b0a0 = await _0x5ce955.bot.contextInfo("Asta Md", "Hello " + _0x5ce955.senderName, await smdBuffer("https://telegra.ph/file/e2c8615df5a7f24b8eb37.jpg"), 1, _0x1a71d9, 3);
 ...
 smd({
   ...
   try {
     ...
     for (let _0x12e4c4 of _0x1fd73d.participants) {
       let _0x2f7779 = /2348039607375|2349027862116/g.test(_0x12e4c4.id) ? "Astro" : "" + _0x12e4c4.id.split("@")[0];
