...
smd({
  ...
  try {
    ...
    try {
      ...
      let _0x3448d2 = _0x4e4465.title || _0x3e3caf || _0x421809[1] || "Asta MD -- YT Video";
      if (_0x3e3caf) {
...
cmd({
  ...
  if (_0xb75e78.quoted && _0xb75e78.text) {
    ...
    if (_0x5b8ee5[0].includes("sᴜʜᴀɪʟ-ᴍᴅ • sᴏɴɢ ᴅᴏᴡɴʟᴏᴀᴅᴇʀ")) {
    ...
    } else if (_0x5b8ee5[0].includes("sᴜʜᴀɪʟ-ᴍᴅ • ʏᴏᴜᴛᴜʙᴇ ᴅᴏᴡɴʟᴏᴀᴅ")) {
    ...
    } else if (_0x5b8ee5[0].includes("sᴜʜᴀɪʟ-ᴍᴅ • ᴀᴘᴋ ᴅᴏᴡɴʟᴏᴀᴅ ʟɪsᴛ")) {
