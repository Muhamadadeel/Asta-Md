const {
 ...
 cmd({
   ...
   try {
     ...
     let _0xa539f7 = "*sᴜʜᴀɪʟ-ᴍᴅ • ʏᴏᴜᴛᴜʙᴇ ᴅᴏᴡɴʟᴏᴀᴅ* \n*_______________________________* \n\n*_Reply Any Number To Download._*\n_Results For : " + _0x4d11cf + "_ \n";
     let _0x5c05ac = 1;
 ...
 cmd({
   ...
   if (_0x4a18ed.quoted && _0x4a18ed.text) {
     ...
     if (_0x2d1ff5[0].includes("sᴜʜᴀɪʟ-ᴍᴅ • sᴏɴɢ ᴅᴏᴡɴʟᴏᴀᴅᴇʀ")) {
     ...
     } else if (_0x2d1ff5[0].includes("sᴜʜᴀɪʟ-ᴍᴅ • ʏᴏᴜᴛᴜʙᴇ ᴅᴏᴡɴʟᴏᴀᴅ")) {
     ...
     } else if (_0x2d1ff5[0].includes("sᴜʜᴀɪʟ-ᴍᴅ • ᴀᴘᴋ ᴅᴏᴡɴʟᴏᴀᴅ ʟɪsᴛ")) {
