...
smd({
  ...
  try {
    ...
    let _0x44b37a = sᴜʜᴀɪʟ_ᴍᴅ_numGuess[_0x131859];
    ...
    if (_0x2bfba9 === "end" && _0x44b37a) {
      if (_0xc06dac) {
        delete sᴜʜᴀɪʟ_ᴍᴅ_numGuess[_0x131859];
    ...
    if (!_0x44b37a) {
      sᴜʜᴀɪʟ_ᴍᴅ_numGuess[_0x131859] = new GuessingGame();
    }
    _0x44b37a = sᴜʜᴀɪʟ_ᴍᴅ_numGuess[_0x131859];
...
smd({
  ...
  let _0x20d34d = sᴜʜᴀɪʟ_ᴍᴅ_cfg[_0x4f21cc];
  ...
  if (!_0x20d34d) {
    ...
    sᴜʜᴀɪʟ_ᴍᴅ_cfg[_0x4f21cc] = _0x20d34d;
  }
  try {
...
smd({
  ...
  let _0x202014 = sᴜʜᴀɪʟ_ᴍᴅ_cfg[_0xa871db];
  if (_0x202014) {
    if (!_0x5157de && _0xea0ced !== _0x202014.player2 && _0xea0ced !== _0x202014.player1) {
      ...
      delete sᴜʜᴀɪʟ_ᴍᴅ_cfg[_0xa871db];
...
smd({
  ...
  const _0x47f35e = sᴜʜᴀɪʟ_ᴍᴅ_cfg[_0x4d1cd7];
  if (!_0x47f35e) {
    return;
  }
  ...
  if (_0x47f35e.gameStatus && _0x47f35e.currentPlayer === _0xcabf04.sender && !isNaN(_0x5acce8)) {
    try {
      ...
      if (!_0x1521ca) {
        ...
        delete sᴜʜᴀɪʟ_ᴍᴅ_cfg[_0x4d1cd7];
...
async function timerFuntions(_0x538b5f, _0x59929b) {
  ...
  delete sᴜʜᴀɪʟ_ᴍᴅ_Capital[_0x538b5f.sender];
}
smd({
  pattern: "co",
  alias: ["capital"],
  ...
  if (!sᴜʜᴀɪʟ_ᴍᴅ_Capital[_0x45934d.sender]) {
    sᴜʜᴀɪʟ_ᴍᴅ_Capital[_0x45934d.sender] = {
      id: _0x45934d.chat,
  ...
  let _0x5645fb = sᴜʜᴀɪʟ_ᴍᴅ_Capital[_0x45934d.sender];
...
smd({
  ...
  let _0x53feb3 = sᴜʜᴀɪʟ_ᴍᴅ_hcg[_0x2ffd5e];
  ...
  if (!_0x53feb3) {
    ...
    sᴜʜᴀɪʟ_ᴍᴅ_hcg[_0x2ffd5e] = _0x53feb3;
  }
...
cmd({
  ...
  try {
    const _0x35d41c = sᴜʜᴀɪʟ_ᴍᴅ_hcg[_0x5d0144];
    if (_0x35d41c && _0x35d41c.gameStatus && _0x35d41c.currentPlayer === _0x16aecb.sender && !isNaN(_0x2091f2) && _0x16aecb.text) {
      ...
      if (!_0x35d41c.gameStatus) {
        delete sᴜʜᴀɪʟ_ᴍᴅ_hcg[_0x16aecb.chat];
      }
      if (_0x2b3010) {
  ...
  try {
    const _0x34ca41 = sᴜʜᴀɪʟ_ᴍᴅ_numGuess[_0x5d0144];
    if (_0x34ca41) {
      if (_0x34ca41.id === _0x16aecb.chat && _0x34ca41.player === _0x16aecb.sender && !isNaN(_0x2091f2)) {
        ...
        if (_0x34ca41.guessedNumber < _0x34ca41.randomNumber) {
          ...
          delete sᴜʜᴀɪʟ_ᴍᴅ_numGuess[_0x5d0144];
        }
      }
    }
  } catch (_0x1fe0b3) {
  ...
  try {
    const _0x2e9c6b = sᴜʜᴀɪʟ_ᴍᴅ_Capital[_0x16aecb.sender];
    if (_0x2e9c6b && _0x2e9c6b.id === _0x5d0144 && _0x2e9c6b.player === _0x16aecb.sender && _0x2e9c6b.preAns !== _0x16aecb.text) {
      ...
      if (_0x16aecb.text.toLowerCase() === _0x2e9c6b.capital.toLowerCase()) {
        ...
        delete sᴜʜᴀɪʟ_ᴍᴅ_Capital[_0x16aecb.sender];
        try {
          if (global.isMongodb) {
    ...
    this.turnIntervalId = setInterval(() => {
      ...
      if (this.currentRemTime === 0 && this.gameStatus) {
        try {
          ...
          this.stopTurn();
          delete sᴜʜᴀɪʟ_ᴍᴅ_wcg[_0x346961.chat];
        } catch (_0x2eafa3) {
...
smd({
  ...
  let _0x17a140 = sᴜʜᴀɪʟ_ᴍᴅ_wcg[_0x3e403e];
  if (_0x42e9b0.startsWith("end") && _0x17a140) {
    _0x17a140.stopTurn();
    delete sᴜʜᴀɪʟ_ᴍᴅ_wcg[_0x3e403e];
  ...
  if (!_0x17a140) {
    ...
    sᴜʜᴀɪʟ_ᴍᴅ_wcg[_0x3e403e] = _0x17a140;
  }
...
smd({
  ...
  let _0x19b4bc = sᴜʜᴀɪʟ_ᴍᴅ_wcg[_0x4d8134];
  if (_0x19b4bc) {
    if (!_0x283363 && _0x2b145d !== _0x19b4bc.player2 && _0x2b145d !== _0x19b4bc.player1 && !_0x1bb0fc) {
      ...
      delete sᴜʜᴀɪʟ_ᴍᴅ_hcg[_0x4d8134];
    }
  } else {
    _0x54222a("┏━━━━━━━━━━━━━━━━━━┓\n┃   WORD CHAIN 404Error    ┃\n┗━━━━━━━━━━━━━━━━━━┛ \n\n*Uhh Dear, _Theres No Game Started yet in This Chat_*\n");
  }
...
smd({
  ...
  const _0x1dda4f = sᴜʜᴀɪʟ_ᴍᴅ_wcg[_0x2b4276];
  if (!_0x1dda4f) {
    return;
  }
  ...
  if (_0x1dda4f.gameStatus && _0x1dda4f.currentPlayer === _0x31d911.sender && _0x31d911.text && !_0x1dda4f.botPlayer) {
    ...
    if (_0x679d9a.length >= _0x1dda4f.wordLength && _0x679d9a.charAt(0) === _0x1dda4f.previousWord.slice(-1)) {
      ...
      if (_0x1dda4f.wrongAttempts[_0x1dda4f.currentPlayer] >= _0x1dda4f.maxAttempts) {
        _0x1dda4f.stopTurn();
        delete sᴜʜᴀɪʟ_ᴍᴅ_wcg[_0x2b4276];
