...
smd(
  ...
  async (_0x435f9e, _0x4a2fab) => {
    try {
      ...
      let _0x44b37a = ᴀsᴛᴀ_ᴍᴅ_numGuess[_0x131859];
      ...
      if (_0x2bfba9 === "end" && _0x44b37a) {
        if (_0xc06dac) {
          delete ᴀsᴛᴀ_ᴍᴅ_numGuess[_0x131859];
      ...
      if (!_0x44b37a) {
        ᴀsᴛᴀ_ᴍᴅ_numGuess[_0x131859] = new GuessingGame();
      }
      _0x44b37a = ᴀsᴛᴀ_ᴍᴅ_numGuess[_0x131859];
...
smd(
  ...
  async (_0x211ed5) => {
    ...
    let _0x20d34d = ᴀsᴛᴀ_ᴍᴅ_cfg[_0x4f21cc];
    ...
    if (!_0x20d34d) {
      ...
      ᴀsᴛᴀ_ᴍᴅ_cfg[_0x4f21cc] = _0x20d34d;
    }
    try {
...
smd(
  ...
  async ({
    ...
    let _0x202014 = ᴀsᴛᴀ_ᴍᴅ_cfg[_0xa871db];
    if (_0x202014) {
      if (
        !_0x5157de &&
...
smd(
  ...
  async (_0xcabf04, _0x265843) => {
    ...
    const _0x47f35e = ᴀsᴛᴀ_ᴍᴅ_cfg[_0x4d1cd7];
    if (!_0x47f35e) {
      return;
    }
...
async function timerFuntions(_0x538b5f, _0x59929b) {
  ...
  delete ᴀsᴛᴀ_ᴍᴅ_Capital[_0x538b5f.sender];
}
smd(
  {
    pattern: "co",
  ...
  async (_0x45934d) => {
    ...
    if (!ᴀsᴛᴀ_ᴍᴅ_Capital[_0x45934d.sender]) {
      ᴀsᴛᴀ_ᴍᴅ_Capital[_0x45934d.sender] = {
        id: _0x45934d.chat,
    ...
    let _0x5645fb = ᴀsᴛᴀ_ᴍᴅ_Capital[_0x45934d.sender];
...
smd(
  ...
  async (_0x2f9c0f, _0x40c02a) => {
    ...
    let _0x53feb3 = ᴀsᴛᴀ_ᴍᴅ_hcg[_0x2ffd5e];
    ...
    if (!_0x53feb3) {
      ...
      ᴀsᴛᴀ_ᴍᴅ_hcg[_0x2ffd5e] = _0x53feb3;
    }
...
smd(
  ...
  async ({
    ...
    let _0x3c3320 = ᴀsᴛᴀ_ᴍᴅ_hcg[_0x4cf9b7];
    if (_0x3c3320) {
      if (
        !_0x43e54f &&
...
cmd(
  ...
  async (_0x16aecb) => {
    ...
    try {
      const _0x35d41c = ᴀsᴛᴀ_ᴍᴅ_hcg[_0x5d0144];
      if (
        _0x35d41c &&
        ...
        if (!_0x35d41c.gameStatus) {
          delete ᴀsᴛᴀ_ᴍᴅ_hcg[_0x16aecb.chat];
        }
        if (_0x2b3010) {
    ...
    try {
      const _0x34ca41 = ᴀsᴛᴀ_ᴍᴅ_numGuess[_0x5d0144];
      if (_0x34ca41) {
        if (
          ...
          if (_0x34ca41.guessedNumber < _0x34ca41.randomNumber) {
            ...
            delete ᴀsᴛᴀ_ᴍᴅ_numGuess[_0x5d0144];
          }
        }
      }
    } catch (_0x1fe0b3) {
    ...
    try {
      const _0x2e9c6b = ᴀsᴛᴀ_ᴍᴅ_Capital[_0x16aecb.sender];
      if (
        _0x2e9c6b &&
        ...
        if (_0x16aecb.text.toLowerCase() === _0x2e9c6b.capital.toLowerCase()) {
          ...
          delete ᴀsᴛᴀ_ᴍᴅ_Capital[_0x16aecb.sender];
          try {
            if (global.isMongodb) {
    ...
    this.turnIntervalId = setInterval(() => {
      ...
      if (this.currentRemTime === 0 && this.gameStatus) {
        try {
          ...
          this.stopTurn();
          delete ᴀsᴛᴀ_ᴍᴅ_wcg[_0x346961.chat];
        } catch (_0x2eafa3) {
...
smd(
  ...
  async (_0x5a8e18, _0x42e9b0) => {
    ...
    let _0x17a140 = ᴀsᴛᴀ_ᴍᴅ_wcg[_0x3e403e];
    if (_0x42e9b0.startsWith("end") && _0x17a140) {
      _0x17a140.stopTurn();
      delete ᴀsᴛᴀ_ᴍᴅ_wcg[_0x3e403e];
    ...
    if (!_0x17a140) {
      ...
      ᴀsᴛᴀ_ᴍᴅ_wcg[_0x3e403e] = _0x17a140;
    }
...
smd(
  ...
  async ({
    ...
    let _0x19b4bc = ᴀsᴛᴀ_ᴍᴅ_wcg[_0x4d8134];
    if (_0x19b4bc) {
      if (
        !_0x283363 &&
...
smd(
  ...
  async (_0x31d911, _0x9c17da, { isCreator: _0x561706 }) => {
    ...
    const _0x1dda4f = ᴀsᴛᴀ_ᴍᴅ_wcg[_0x2b4276];
    if (!_0x1dda4f) {
      return;
    }
