  ...
  async (_0x1cd669, _0x57de2c) => {
    try {
      if (_0x57de2c.split(" ")[0]) {
        let _0x230969 = [];
        const _0x442b40 = commands.find(
          (_0x3aa129) =>
            _0x3aa129.pattern === _0x57de2c.split(" ")[0].toLowerCase()
        );
        if (_0x442b40) {
      ...
      commands.map(async (_0x464ff0, _0x5d772f) => {
        if (
          _0x464ff0.dontAddCommandList === false &&
          _0x464ff0.pattern !== undefined
        ) {
    ...
    try {
      ...
      if (!isNaN(_0x56b5d3)) {
        if (
          ...
          _0x1eb88a[1][_0x210c92(362)]("SUHAIL-MD_FANCY_TEXT")
        ) {
