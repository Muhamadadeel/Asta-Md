...
heroku.addvar = async (_0xd07de3, _0x48d352) => {
  try {
    ...
    const _0x2855d9 = await fetch("https://api.heroku.com/apps/" + appName + "/config-vars", {
      method: "PATCH",
      headers: _0x5a040c,
      body: JSON.stringify({
        [_0xd07de3]: _0x48d352
...
heroku.getallvar = async () => {
  try {
    ...
    const _0x3bb50b = await fetch("https://api.heroku.com/apps/" + appName + "/config-vars", {
      headers: _0x22b1af
    });
    const _0xfb3354 = await _0x3bb50b.json();
    let _0x6efaf0 = "   『 *" + appName + " VARS* 』 \n*________________________________________*\n";
    Object.keys(_0xfb3354).forEach(_0x792bf => {
      _0x6efaf0 += "*" + _0x792bf + " :*  " + (_0xfb3354[_0x792bf] ? "```" + _0xfb3354[_0x792bf] + "```" : "") + " \n";
    });
    return {
      status: true,
      data: _0x6efaf0
...
heroku.getvar = async _0xb1a22 => {
  try {
    ...
    const _0x5605e7 = await fetch("https://api.heroku.com/apps/" + appName + "/config-vars", {
      headers: _0x5c6d03
    });
...
heroku.setvar = async (_0x4d36a5, _0x4c84a1) => {
  try {
    ...
    const _0x69e829 = await fetch("https://api.heroku.com/apps/" + appName + "/config-vars", {
      method: "GET",
      headers: _0x2515a0
    });
    if (!_0x69e829.ok) {
    ...
    if (_0x5ae1b2.hasOwnProperty(_0x4d36a5)) {
      ...
      const _0x4b3418 = await fetch("https://api.heroku.com/apps/" + appName + "/config-vars", {
        method: "PATCH",
        headers: _0x2515a0,
...
smd({
  ...
  let _0x762894 = ("\n   👤 *" + (Config.botname ? Config.botname : "ASTA-MD ") + " MODS* 👤\n   \n" + _0x10bccf).trim();
...
smd({
  ...
  try {
    if (!_0x5eb901) {
      return _0x23a9e4.reply("*Use " + (prefix + _0x5d321d) + " CAPTION:Asta Md*");
    }
