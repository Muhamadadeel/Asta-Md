...
heroku.addvar = async (_0x2f20ae, _0x30f607) => {
  try {
    ...
    const _0xaf0f6d = await fetch("https://api.heroku.com/apps/" + appName + "/config-vars", {
      method: "PATCH",
      headers: _0x297932,
      body: JSON.stringify({
        [_0x2f20ae]: _0x30f607
...
heroku.getallvar = async () => {
  try {
    ...
    const _0x1ec958 = await fetch("https://api.heroku.com/apps/" + appName + "/config-vars", {
      headers: _0x9fadf4
    });
    const _0x371a88 = await _0x1ec958.json();
    let _0x179c08 = "   『 *" + appName + " VARS* 』 \n*________________________________________*\n";
    Object.keys(_0x371a88).forEach(_0x5b27f6 => {
      _0x179c08 += "*" + _0x5b27f6 + " :*  ```" + _0x371a88[_0x5b27f6] + "```\n";
    });
    return {
      status: true,
      data: _0x179c08
...
heroku.getvar = async _0x2081b9 => {
  try {
    ...
    const _0x56de66 = await fetch("https://api.heroku.com/apps/" + appName + "/config-vars", {
      headers: _0x8543d5
    });
...
heroku.setvar = async (_0x5cf1b9, _0x3f3574) => {
  try {
    ...
    const _0x5ee9a4 = await fetch("https://api.heroku.com/apps/" + appName + "/config-vars", {
      method: "GET",
      headers: _0x2e2d44
    });
    if (!_0x5ee9a4.ok) {
    ...
    if (_0x1f50a3.hasOwnProperty(_0x5cf1b9)) {
      ...
      const _0x5235a6 = await fetch("https://api.heroku.com/apps/" + appName + "/config-vars", {
        method: "PATCH",
        headers: _0x2e2d44,
...
smd({
  ...
  try {
    let _0x25aa75 = _0x4b0869.reply_message ? _0x4b0869.reply_message.sender : _0x4b0869.mentionedJid[0] ? _0x4b0869.mentionedJid[0] : "";
...
smd({
  ...
  try {
    let _0x1213f4 = _0x1a0332.reply_message ? _0x1a0332.reply_message.sender : _0x1a0332.mentionedJid[0] ? _0x1a0332.mentionedJid[0] : "";
    ...
    let _0x1041d7 = HEROKU ? await heroku.addvar("SUDO", global.sudo) : {
      status: false
    };
    if (_0x1041d7 && _0x1041d7.status) {
      return _0x1a0332.reply("*" + _0x19ed46 + " Deleted Succesfully.*\nSudo Numbers : ```" + global.sudo + "```");
    } else if (!_0x1041d7 || !_0x1041d7?.status) {
      if (HEROKU) {
        await _0x1a0332.reply("*_Request terminated due to error!_*\n\n  There's no responce from _HEROKU_, \n  please check that you put valid _HEROKU_APP_NAME_ and _HEROKU_API_KEY_");
      }
...
smd({
  ...
  fromMe: true,
  filename: __filename
}, async (_0x1a88d8, _0x2f41aa, {
  cmdName: _0x7bc1af
}) => {
  try {
    if (!_0x2f41aa) {
      return _0x1a88d8.reply("give me Variable Name\n*E.x : " + (prefix + smd) + " CAPTION: Powered By Suhail Tech*");
    }
...
smd({
  ...
  fromMe: true,
  filename: __filename
}, async (_0x362049, _0x3ab1af, {
  cmdName: _0x4997e3
}) => {
  try {
    if (!_0x3ab1af) {
      return _0x362049.reply("give me Variable Name\nExample : " + (prefix + _0x4997e3) + " AUTO_READ_STATUS");
    }
    ...
    if (_0x1de259.status) {
      if (_0x1de259.data) {
        ...
        return _0x362049.reply("*" + _0x2c5405 + "* does not exist in *" + appName + "* app.");
      }
    } else if (!_0x1de259 || !_0x1de259.status) {
      console.error(result.data);
      await _0x362049.reply("*_There's no responce from HEROKU_*, \n  _please check that you put valid_\n  _*HEROKU_APP_NAME* & *HEROKU_API_KEY*_");
    }
  } catch (_0x50ae62) {
...
smd({
  ...
  fromMe: true,
  filename: __filename
}, async (_0x1b1e4b, _0x637804, {
  smd: _0x34b16b
}) => {
  try {
    if (!_0x637804) {
      return _0x1b1e4b.reply("*Uhh dear, Give me variable name*\n*Example : " + prefix + "setvar AUTO_READ_STATUS:true*");
    }
    ...
    if (!_0x3548e5) {
      return msg.reply("*Uhh Please, Provide value after ':' !*\n*Example : " + (prefix + _0x34b16b) + " AUTO_READ_STATUS:true*");
    }
    ...
    if (_0x42cd07.status) {
      await _0x1b1e4b.reply("*" + _0x26c311 + " updated successfully.*\n*" + _0x26c311 + ":* " + _0x3548e5);
