...
smd({
  ...
  try {
    ...
    if (_0x417018) {
      ...
      try {
        var _0x3a49e9 = await _0x1d2f1f.bot.groupInviteCode(_0x417018.id);
      } catch {
        var _0x3a49e9 = false;
      }
...
smd({
  ...
  try {
    ...
    if (!_0x90a6de.isBotAdmin || !_0x90a6de.isAdmin) {
      return await _0x90a6de.reply(!_0x90a6de.isBotAdmin ? "*_I'm Not Admin In This Group" + (!_0x90a6de.isCreator ? ", Sir" : "") + "_*" : tlang().admin);
    }
...
smd({
  ...
  try {
    ...
    if (!_0x25d56b.isBotAdmin || !_0x25d56b.isAdmin) {
      return await _0x25d56b.reply(!_0x25d56b.isBotAdmin ? "*_I'm Not Admin In This Group" + (!_0x25d56b.isCreator ? ", Sir" : "") + "_*" : tlang().admin);
    }
    try {
...
smd({
  ...
  try {
    ...
    if (!_0x5ac912.isBotAdmin || !_0x5ac912.isAdmin) {
      return await _0x5ac912.reply(!_0x5ac912.isBotAdmin ? "*_I'm Not Admin In This Group" + (!_0x5ac912.isCreator ? ", Sir" : "") + "_*" : tlang().admin);
    }
