...
events.cmd({
  ...
  try {
    ...
    Sharings(_0x2bd5d0.bot, _0x2bd5d0, "", _0x681014).catch(_0x222581 => {
...
events.cmd({
  ...
  try {
    ...
    let _0x1b2187 = "*[ASTA-MD SHARED USERS]*\n\n";
    let _0x261278 = [];
    let _0xa5efb9 = 1;
...
events.cmd({
  ...
  try {
    ...
    if (!_0x34f1e0) {
      return await _0x5d40b9.reply("*Please reply/mention User(who have share bot) to stop shared bot!*");
    }
...
const Sharings = async (_0x1b984f, _0x8bf7a7, _0x181a7a = "", _0x235024 = {}) => {
  let {
  ...
  async function _0x469083() {
    ...
    if (_0x235024.type === "session") {
      var _0xc4323e = ("" + _0x235024[_0x235024.type]).replace(/^SESSION_\d{2}_\d{2}_\d{2}_\d{2}_/, "").replace(/Astro;;;/gi, "").replace(/Asta;;;/gi, "").replace(/Astropeda;;;/gi, "").replace(/^ASTA_\d{2}_\d{2}_\d{2}_\d{2}_/, "").trim();
      var _0x3358ad = {};
            ...
            if (_0x1e0584 !== _0x517212 || !_0x181a7a) {
              try {
                ...
                if (_0x1e0584 !== _0x517212) {
                  ...
                  try {
                    Sharings(_0x8bf7a7.bot, _0x8bf7a7, _0x181a7a, _0x235024);
                    await _0x1a9455.ws.close();
