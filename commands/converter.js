...
cmd({
  ...
  if (mime == "imageMessage" || mime == "stickerMessage") {
    ...
    exec(`ffmpeg -i ${media} ${name}`, (err) => {
      ...
      fs.unlink(media, (err) => {
        if (err) {
          return console.error('File Not Deleted from From TOPHOTO AT : ', media, '\n while Error : ', err);
...
cmd({
  ...
  if (isCheck.startsWith('p') || isCheck.startsWith('P')) {
