...
async function syncdb() {
    ...
    try {
      ...
      try {
        _0x54e723[_0x2a3e8d.chat] = (await groupdb.findOne({
          ...
          welcome: toBool(global.welcomemsgm)
        }));
  ...
  _0x2131ed.ev.on("connection.update", async _0x4a4534 => {
    ...
    if (_0x117006 === "open") {
      if (/true|ok|sure|yes/gi.test(global.flush) || !_0x2131ed.authState.creds?.myAppStateKeyId) {
        log("Flushing SESSION_ID" + (_0x2131ed.authState.creds?.myAppStateKeyId ? "" : " B'Coz *myAppStateKeyId Missing") + "!");
        _0x2131ed.ev.flush();
      }
      ...
      log("ᴡʜᴀᴛꜱᴀᴘᴘ ᴄᴏɴɴᴇᴄᴛɪᴏɴ ꜱᴜᴄᴄᴇꜱꜱ ✅");
      try {
        try {
        ...
        if (Object.keys(_0x2dc890 || {}).length > 0) {
          ...
          for (const _0x235bb0 in _0x942548) {
            try {
              ...
              if (_0x3b4de2) {
                let _0x4e28ba = _0x235bb0 + (_0x574ef6[_0x235bb0] && /.js|.smd|.suhail/gi.test(_0x574ef6[_0x235bb0]) ? _0x574ef6[_0x235bb0] : ".js");
          ...
          log("\nᴘʟᴜɢɪɴꜱ ɪɴꜱᴛᴀʟʟᴇᴅ ꜱᴜᴄᴄᴇꜱꜱꜰᴜʟʟʏ ✅");
        }
      } catch (_0xd95311) {
        log("ᴘʟᴜɢɪɴꜱ ꜰᴀɪʟᴇᴅ ᴛᴏ ɪɴꜱᴛᴀʟʟ⚠️", e);
      }
      await loadPlugins(plugin_dir);
      let _0x42876d = "\n `ASTA- CONNECTED` \n\n  Prefix  : [ " + (prefix ? prefix : "null") + " ]\n  Plugins : " + events.commands.length + "\n  Mode    : " + Config.WORKTYPE + "\n  Database: " + (isMongodb ? "MongoDb" : sqldb ? "PostegreSql" : "DATABASE(none)");
      try {
        const _0x7b3f27 = require("../lib/scraper");
        let _0x1d78d5 = await _0x7b3f27.syncgit();
        if (_0x1d78d5.total !== 0) {
          _0x42876d += "\nɴᴇᴡ ᴜᴘᴅᴀᴛᴇ ꜰᴏᴜɴᴅ!\nᴄʜᴇᴄᴋ ᴏᴜᴛ https:github.com/Astropeda/whatsapp-bot\n";
        }
      } catch (_0x3209eb) {}
      global.qr_message = {
        message: "ᴄᴏɴɴᴇᴄᴛᴇᴅ ʙᴏᴛ",
        bot_user: _0x262d57,
  ...
  _0x2131ed.sendUi = async (_0xa0a74f, _0x502e3a = {}, _0x356cb6 = "", _0x49add3 = "", _0x296671 = "", _0x182f83 = false) => {
    ...
    try {
      ...
      let _0xf3127b;
      if ((_0x182f83 && _0x296671 && global.botstyle > 0 || !_0x296671) && /text|txt|nothing|smd|suhail/.test(global.userImages) || _0x49add3 == "text") {
        _0xf3127b = {
      ...
      const _0x311051 = _0x182f83 && _0x296671 && global.botstyle > 0 ? await smdBuffer(_0x296671) : null;
      _0x5ae67d = {
  ...
  _0x2131ed.contextInfo = async (_0x585d08 = Config.botname, _0x4b3529 = Config.ownername, _0x3d9548 = log0, _0xca9b7b = 1, _0x2390df = gurl, _0x2dbdcf = false) => {
    try {
      let _0x1af976 = _0x2dbdcf ? _0x2dbdcf : global.botstyle;
      if (_0x1af976 >= 5) {
        return {
          externalAdReply: {
            title: _0x585d08,
...
async function loadPlugins(_0x3ee9d1) {
  try {
    fs.readdirSync(_0x3ee9d1).forEach(_0x35ebb3 => {
      ...
      } else if ([".js", ".smd"].includes(path.extname(_0x35ebb3).toLowerCase())) {
        try {
          require(_0x47b129);
        } catch (_0x35f891) {
...
async function MakeSession(_0x1e5f78 = SESSION_ID, _0x5a9275 = __dirname + baileys, _0x47ef1c = false) {
  let _0xab543b = ("" + _0x1e5f78).replace(/^SESSION_\d{2}_\d{2}_\d{2}_\d{2}_/gi, "").replace(/^SESSION_ID_\d{2}_\d{2}_\d{2}_\d{2}_/gi, "").replace(/^ASTA_\d{2}_\d{2}_\d{2}_\d{2}_/gi, "").replace(/Asta;;;/gi, "").replace(/Asta_Bot;;;/gi, "").replace(/gnime;;;/gi, "").trim();
  ...
  if (_0x533fc2) {
    ...
    if (_0xab543b && /guru/gi.test(_0xab543b) && _0xab543b.length < 30) {
      ...
      try {
        ...
        log("\nᴇʀʀᴏʀ ɢᴇᴛᴛɪɴɢ ꜱᴇꜱꜱɪᴏɴ_ɪᴅ ꜰʀᴏᴍ ꜱᴇʀᴠᴇʀ\n \nꜱᴄᴀɴ Qʀ ꜰʀᴏᴍ [ " + global.scan + " ]\n");
      }
    } else if (_0xab543b) {
      try {
        log("⚠️ᴠᴀɪʟᴅᴀᴛɪɴɢ ꜱᴇꜱꜱɪᴏɴ ɪᴅ");
        ...
        log("\nꜱᴇꜱꜱɪᴏɴ ꜰɪʟᴇ ꜱᴀᴠᴇᴅ ꜱᴜᴄᴄᴇꜱꜱꜰᴜʟʟʏ ✅");
      } catch (_0x8f3ce5) {
        log("❌ɪɴᴠᴀʟɪᴅ ꜱᴇꜱꜱɪᴏɴ_ɪᴅ ᴇʀʀᴏʀ ꜰʀᴏᴍ ꜱᴇʀᴠᴇʀ\nᴘʟᴇᴀꜱᴇ ꜱᴄᴀɴ ᴛʜᴇ Qʀ ᴀɢᴀɪɴ ꜰʀᴏᴍ [ " + global.scan + " ]\n\n\nERROR : ", _0x8f3ce5);
      }
    }
  } else {
    SmdOfficial = false;
    log("\n\nᴀ ᴄʜᴇᴀᴘ ᴄᴏᴘʏ ᴏꜰ ᴀꜱᴛᴀ ᴡᴀꜱ ꜰᴏᴜɴᴅ \nᴅᴇᴘʟᴏʏ ꜰʀᴏᴍ: https://github.com" + _0x2fffa6 + "Suhail-Md\n");
    process.exit(0);
  }
}
async function main() {
