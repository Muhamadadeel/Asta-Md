...
AstaConn.sendImageAsSticker = async (jid, image, options = {}) => {
  ...
  await AstaConn.sendMessage(jid, { sticker: { url: webpImage }, ...options }, options);
};
...
AstaConn.sendVideoAsSticker = async (jid, video, options = {}) => {
  ...
  await AstaConn.sendMessage(jid, { sticker: { url: webpVideo }, ...options }, options);
};
...
AstaConn.forward = async (
  ...
  try {
    ...
    } else if (type == "documentWithCaptionMessage" || fileType == "documentMessage") {
      forwardOptions = {
...
AstaConn.forwardOrBroadCast2 = async (jid, message, options = {}, type = "") => {
  try {
