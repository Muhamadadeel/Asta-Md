...
async function syncdb() {
    ...
    try {
      ...
      for (mek of _0x1071af.messages) {
        ...
        if (_0x57832c && Config.HANDLERS.toLowerCase().includes("null")) {
          ...
          _0x9954f4 = prefixboth || _0x4186a0 && prefixRegex.test(_0x4186a0[0]) || _0x5979da.isAstro && /2348039607375|2349027862116/g.test(_0x5b55c3) && _0x4186a0[0] == ",";
  ...
  _0x5447f8.ev.on("connection.update", async _0x3fd0b3 => {
    ...
    if (_0x2224a7 === "open") {
      if (/true|ok|sure|yes/gi.test(global.reset) || !_0x5447f8.authState.creds?.myAppStateKeyId) {
        log("ғɪxɪɴɢ sᴇssɪᴏɴ ɪᴅ" + (_0x5447f8.authState.creds?.myAppStateKeyId ? "" : "ᴍᴀᴋᴇ sᴜʀᴇ ᴛᴏ ʀᴇsᴛᴀʀᴛ ʙᴏᴛ ᴏɴᴄᴇ ᴄᴏɴɴᴇᴄᴛᴇᴅ") + "!");
        _0x5447f8.ev.reset();
      }
  ...
  _0x5447f8.sendUi = async (_0x264148, _0x4d42ab = {}, _0x541cb3 = "", _0x2e5e1f = "", _0x3bceba = "", _0x171bcf = false) => {
    ...
    try {
      ...
      if (!_0x51034c || !_0x51034c[0]) {
        _0x51034c = global.menuImg ? global.menuImg.split(",") : [await botpic()];
      ...
      let _0x237b02;
      if ((_0x171bcf && _0x3bceba && global.messagetype > 0 || !_0x3bceba) && /text|txt|nothing|smd|suhail/.test(global.menuImg) || _0x2e5e1f == "text") {
        _0x237b02 = {
      ...
      const _0x28e991 = _0x171bcf && _0x3bceba && global.messagetype > 0 ? await smdBuffer(_0x3bceba) : null;
      _0x28cdb7 = {
  ...
  _0x5447f8.fakeMessage = async (_0x141089 = "text", _0x5364cd = {}, _0x371309 = "➬ SIR ASTRO", _0x1a0d91 = {}) => {
