  ...
  try {
    ...
    for (const _0x55bb42 of _0x55b13f) {
      ...
      if (_0x1cf682.length >= 1) {
        ...
        _0xef10c6 = /suhail|amd|message|chat/gi.test(_0xef10c6) ? "suhail" : _0xef10c6;
...
setMention.cmd = async (_0x501ec5, _0x2a1c43 = "") => {
  try {
    ...
    if (_0x2a1c43 === "get" || _0x2a1c43 === "info" || !_0x2a1c43 && _0x22516b.status && _0x22516b.get) {
      ...
      _0x501ec5.reply("_Read wiki to set mention message https://github.com/SuhailTechInfo/Suhail-Md/wiki/mention_", {}, "amd");
