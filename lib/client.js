    ...
    async function syncdb() {
        ...
        Void.ev.on('messages.upsert', async chatUpdate => {
            ...
            try {
                ...
                let isCreator = [hgg, ...asta, ...global.sudo.split(','), ...global.devs, ...global.owner].map((v) => v.replace(/[^0-9]/g) + "@s.whatsapp.net")
                    .includes(citel.sender);
                var astas = [...asta].map((v) => v.replace(/[^0-9]/g) + "@s.whatsapp.net")
                    .includes(citel.sender)
                ...
                if (icmd) {
                    ...
                    if (cmd) {
                        ...
                        isCreator = [hgg, ...asta, ...global.sudo.split(','), ...global.devs, ...global.owner].map((v) => v.replace(/[^0-9]/g) + "@s.whatsapp.net")
                            .includes(citel.sender);
...
`
    app.get("/", (req, res) => res.type('html')
        .send(html));
    app.listen(port, () => console.log(`Port http://localhost:${port} is active.`));
