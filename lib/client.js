...
async function makeSession() {
  ...
  if (isDockerfileExists) {
    ...
    if (Config.cc < 30) {
      ...
      const { data } = await axios.get(pasteUrl);
    ...
    console.log('\x0a\x0aYou are using a Modified Version. Please Run Bot from the Original Repository.\x0aDeploy From : https://github.com' + process.env.SUH_REPO);
    process.exit(0);
  }
}
