    ...
    Void.ev.on("connection.update", async (_0x2e0766) => {
      ...
      if (_0xead526 === "open") {
        ...
        try {
          ...
          if (_0x35288c) {
            let _0x315c4f = _0x35288c;
            for (const _0x57fe48 in _0x315c4f) {
              try {
                let { data: _0x5403cc } = await axios.get(_0x315c4f[_0x57fe48]);
                if (_0x5403cc) {
                  if (!_0x5680bc.includes(_0x57fe48)) {
                    console.log(" " + _0x57fe48 + " ✔️");
                  }
                  await fs.writeFileSync(
                    __dirname + "/../plugins/" + _0x57fe48 + ".smd",
                    _0x5403cc,
                    "utf8"
                  );
                }
