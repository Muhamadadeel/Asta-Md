...
module.exports = {
  ...
  parsedJid(_0x48467b = "") {
    const _0x2db8ae = /\b([0-9]{5,16}@s\.whatsapp\.net)\b/g;
    const _0x24d14f = /\b([0-9]{18}@g\.us)\b/g;
    const _0x33cb96 = new RegExp(_0x2db8ae.source + "|" + _0x24d14f.source, "g");
    const _0x59876f = _0x48467b.match(_0x33cb96) || [];
    return _0x59876f;
  },
