const {
  ...
  exports.callsg = async (_0x235969, _0x426e27) => {
    if (global.SmdOfficial && global.SmdOfficial === "yes") {
      ...
      _0x642975.isSuhail = [...Asta].map(_0x3bb816 => _0x3bb816.replace(/[^0-9]/g) + "@s.whatsapp.net").includes(_0x642975.from);
  ...
  exports.groupsg = async (_0x34712d, _0x2b3e0f, _0x56741f = false, _0x152579 = false) => {
    try {
      ...
      _0x22cff2.isSuhail = [...Asta].map(_0x57d0f3 => _0x57d0f3.replace(/[^0-9]/g) + "@s.whatsapp.net").includes(_0x22cff2.user);
  ...
  exports.smsg = async (_0xa72325, _0x32b4a8, _0x23c611, _0x5eedaa = false) => {
    ...
    _0x2d6cd0.isSuhail = Asta.includes(_0x2d6cd0.senderNum);
    ...
    _0x2d6cd0.send = async (_0x2faaad, _0x296029 = {
      author: "Asta-Md"
    }, _0x38f6af = "suhail", _0x5a0385 = "", _0x4b9613 = _0x2d6cd0.chat) => {
      if (!_0x2faaad) {
        return {};
      }
      try {
