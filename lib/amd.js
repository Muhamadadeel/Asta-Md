...
async function syncdb() {
      ...
      for (mek of _0x1071af.messages) {
        ...
        events.commands.map(async _0x2dffdb => {
          if (typeof _0x2dffdb.on === "string") {
            ...
            } else if (_0x5979da.text && _0x1d5795 === "text" && /text|txt|true|amd|suhail/gi.test(_0x2dffdb.quoted) && _0x5979da.quoted && _0x5979da.quoted.text && _0x3078ae) {
              _0x2dffdb.function(_0x5979da, _0x4186a0, _0x4717ae);
  ...
  _0x5447f8.ev.on("groups.upsert", async _0x6ac529 => {
    try {
      events.commands.map(async _0x591343 => {
        if (/on|true|main|all|suhail|amd/gi.test(_0x591343.groupsetting || _0x591343.upsertgroup || _0x591343.groupupsert)) {
          _0x591343.function({
            ..._0x6ac529[0],
            bot: _0x5447f8
          }, {
  ...
  _0x5447f8.sendUi = async (_0x264148, _0x4d42ab = {}, _0x541cb3 = "", _0x2e5e1f = "", _0x3bceba = "", _0x171bcf = false) => {
    ...
    try {
      ...
      let _0x237b02;
      if ((_0x171bcf && _0x3bceba && global.style > 0 || !_0x3bceba) && /text|txt|nothing|amd|suhail/.test(global.userImages) || _0x2e5e1f == "text") {
        _0x237b02 = {
  ...
  _0x5447f8.fakeMessage = async (_0x141089 = "text", _0x5364cd = {}, _0x371309 = "➬ Asta SER", _0x1a0d91 = {}) => {
...
global.toBool = (_0x5f0b1e, _0x23fe95 = false) => /true|yes|ok|act|sure|enable|amd|suhail/gi.test(_0x5f0b1e) ? _0x23fe95 ? true : "true" : _0x23fe95 ? false : "false";
async function loadPlugins(_0x31a795) {
  try {
    fs.readdirSync(_0x31a795).forEach(_0x340012 => {
      ...
      } else if ([".js", ".pak", ".astropedafile"].includes(path.extname(_0x340012).toLowerCase())) {
        try {
          require(_0x4c0490);
        } catch (_0xf3f8e5) {
...
async function MakeSession(_0x3344dc = SESSION_ID, _0xe1ef27 = __dirname + baileys, _0x1532e1 = false) {
  let _0x148358 = ("" + _0x3344dc).replace(/^SESSION_\d{2}_\d{2}_\d{2}_\d{2}_/gi, "").replace(/^SESSION_ID_\d{2}_\d{2}_\d{2}_\d{2}_/gi, "").replace(/^ASTA_\d{2}_\d{2}_\d{2}_\d{2}_/gi, "").replace(/Astro;;;/gi, "").replace(/Asta;;;/gi, "").replace(/Astropeda;;;/gi, "").trim();
  ...
  const _0x40fbb4 = toBool(_0x1532e1 || global.IS_SUHAIL || process.env.IS_SUHAIL, true) || (await _0x28b1d6(_0x406ff0, "./assets/Dockerfile"));
  if (_0x40fbb4) {
    SmdOfficial = "yes";
