let options = {
  ...
  tempdb: "creator TEXT DEFAULT 'Sir Astro'",
};
let optJson = {
  bot_: {},
  sck1: {
...
pg.createTable = async (_0x2100aa) => {
  ...
  try {
    ...
    console.log(
      "Error creating PostgreSQL " + _0x2100aa + " Table:",
      _0x673946
    );
  } finally {
    _0x45f62c.release();
...
pg.countDocuments = async (_0x233a0b) => {
  ...
  try {
    const _0x4b5a24 = await _0x5d8046.query(
      "SELECT COUNT(*) FROM " + _0x233a0b
    );
...
pg.findOne = async (_0x22a9f1, _0x38e72f) => {
  ...
  try {
    const _0x40b093 = await _0x556ef5.query(
      "SELECT * FROM " + _0x22a9f1 + " WHERE id = $1",
      [_0x38e72f?.id]
    );
...
pg.updateOne = async (_0x3cb355, _0x548352, _0x479724 = {}) => {
  ...
  try {
    ...
    const _0x5e2b36 =
      "SELECT * FROM " + _0x3cb355 + " WHERE id = $1 FOR UPDATE";
    ...
    console.error(
      "Error while finding and updating " +
        _0x3cb355 +
        " document by Id: " +
        _0x548352?.id +
        "\n",
...
pg.findOneAndDelete = async (_0x113451, _0x2fd313) => {
  ...
  try {
    ...
    const _0x4205b5 = await _0x50b7d5.query(
      "SELECT * FROM " + _0x113451 + " WHERE id = $1 FOR UPDATE",
      [_0x2fd313?.id]
    );
    if (_0x4205b5.rows[0]) {
      const _0x20632f = await _0x50b7d5.query(
        "DELETE FROM " + _0x113451 + " WHERE id = $1 RETURNING *",
        [_0x2fd313.id]
      );
    ...
    console.error(
      "Error while finding and deleting " +
        _0x113451 +
        " document by Id: " +
        _0x2fd313?.id +
        "\n",
...
pg.collection = {
  drop: async (_0x2a2f4e) => {
    ...
    try {
      ...
      console.error(
        "Error while dropping " + _0x2a2f4e + " table\n",
        _0x3fd63d
      );
      return false;
    } finally {
...
let dbs = {
  newtables: {
    bot_: {
      id: "Asta_Md",
      alive_text:
        "ʜᴇʟʟᴏ &user ɪ ᴀᴍ ᴏɴʟɪɴᴇ ᴀɴᴅ ʀᴜɴɴɪɴɢ",
      alive_get:
  ...
  try {
    if (fs.existsSync(__dirname + "/" + _0x4c76be + ".json")) {
      return await JSON.parse(
        fs.readFileSync(__dirname + "/" + _0x4c76be + ".json", "utf8")
      );
    } else {
      fs.writeFileSync(
        __dirname + "/" + _0x4c76be + ".json",
...
dbs.saveGroupData = async (_0x4e0b16, _0x17041b = {}) => {
  fs.writeFileSync(
    __dirname + "/" + _0x4e0b16 + ".json",
    JSON.stringify(_0x17041b, null, 2),
    "utf8"
  );
};
dbs.countDocuments = async (_0x40e980) => {
  try {
    ...
    console.log(
      "Error while countDocuments of " + _0x40e980 + " in database,\n",
      _0x26fc7b
    );
    return 0;
  }
...
dbs.new = async (_0x5cbecc, _0x56893f) => {
  try {
    ...
    console.log(
      "Error while Creating new " + _0x5cbecc + " in database,\n",
      _0x2db0bb
    );
    return {};
  }
...
dbs.findOne = async (_0x5c2c48, _0x46f9e4) => {
  try {
    ...
    console.log(
      "Error while findOne " + _0x5c2c48 + " in database,\n",
      _0x5de72c
    );
    return;
  }
...
dbs.find = async (_0x400b9f, _0x176ccb = {}) => {
  try {
    ...
    console.log(
      "Error while finding  " + _0x400b9f + "(s) in database,\n",
      _0x516c73
    );
    return [];
  }
...
dbs.updateOne = async (_0x2a59d7, _0x4e66f2, _0x525852 = {}) => {
  try {
    ...
    console.log(
      "Error while updateOne " + _0x2a59d7 + " in database,\n",
      _0xc2d328
    );
    return {};
  }
...
dbs.findOneAndDelete = async (_0x1571a5, _0x38c370) => {
  try {
    ...
    console.log(
      "Error while findOneAndDelete " + _0x1571a5 + " in database,\n",
      _0xfe5527
    );
    return null;
  }
...
dbs.collection = {
  drop: async (_0x398a10) => {
    try {
      ...
      Object.keys(_0xf54519).forEach(
        (_0x2ec00a) => delete _0xf54519[_0x2ec00a]
      );
