...
if (fs.existsSync('./src/' + Config.LANG + '.json')) {var json = JSON.parse(fs.readFileSync('./src/' + Config.LANG + '.json'));} 
else {	var json = JSON.parse(fs.readFileSync('./src/SUHAIL.json'));	}	
