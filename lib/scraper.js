...
if (fs.existsSync("./sources/" + Config.LANG + ".json")) {
  var json = JSON.parse(fs.readFileSync("./sources/" + Config.LANG + ".json"));
} else {
  var json = JSON.parse(fs.readFileSync("./sources/SUHAIL.json"));
}
